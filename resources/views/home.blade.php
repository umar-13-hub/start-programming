...
@foreach ($cars as $car)
    <div class="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
        <a class="relative mx-2 mt-2 flex h-30 overflow-hidden rounded-xl" href="#">
            <img class="object-cover" src="https://i.pinimg.com/1200x/f4/f3/fa/f4f3facbae4547ed90b5dcd9b375737c.jpg" />
        ...
        <div class="mt-1 px-5 pb-5">
            <a href="#">
                <h5 class="text-2xl font-bold text-slate-900">{{ $car->name }}</h5>
                <h5 class="text-1xl tracking-tight text-slate-900">{{ $car->colour }}</h5>
            </a>
            <div class="mt-2 mb-5 flex items-center justify-between">
                <p>
                    <span class="text-3xl font-bold text-slate-900">${{ $car->price }}</span>
                </p>
                <div class="flex items-center">
                    ...
                    <span class="mr-2 ml-2 rounded bg-yellow-300 px-2.5 py-0.5 text-1xl font-semibold">5.0</span>
                </div>
            </div>
