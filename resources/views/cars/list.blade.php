<div class="container pb-5 pt-5">
    <div class="align-items-center gx-0 gy-5 mb-5 row">
        <div class="col-lg-7">
            <img src="https://images.unsplash.com/photo-1493238792000-8113da705763?ixid=MnwyMDkyMnwwfDF8c2VhcmNofDJ8fGNhcnxlbnwwfHx8fDE2MzE2NzIwOTU&amp;ixlib=rb-1.2.1q=85&amp;fm=jpg&amp;crop=faces&amp;cs=srgb&amp;w=1000&amp;h=650&amp;fit=crop" class="img-fluid w-100" alt="..." width="1250" height="650">
        </div>
        <div class="col-lg-5">
            <div class="bg-white ms-lg-n5  pb-lg-5 position-relative ps-lg-5 pt-lg-5">
    ...
    <div class="align-items-center gy-4 row">
        <div class="col-lg-4 col-xl-3 me-auto">
            ...
            <p class="mb-0">To call the manager, call <a href="#" class="btn btn-primary pb-2 pe-4 ps-4 pt-2">+79055831313.</a>
                You can also write to us on WhatsApp.</p>
        </div>
        <div class="col-lg-8">
            <div class="row row-cols-lg-3 row-cols-md-3">
                <div class="pb-3 pt-3">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 65 65" xml:space="preserve" fill-rule="evenodd" clip-rule="evenodd" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="2" stroke="currentColor" width="5rem" height="5rem" class="mb-3 text-primary">
                    ...
                    <h4 class="fw-bold h5 mb-0 text-dark">Insured &amp; Safe</h4>
                </div>
                <div class="pb-3 pt-3">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 65 65" xml:space="preserve" fill-rule="evenodd" clip-rule="evenodd" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="2" stroke="currentColor" width="5rem" height="5rem" class="mb-3 text-primary">
                    ...
                    <h4 class="fw-bold h5 mb-0 text-dark">Certified Chauffeur</h4>
                </div>
                <div class="pb-3 pt-3">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 65 65" xml:space="preserve" fill-rule="evenodd" clip-rule="evenodd" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="2" stroke="currentColor" width="5rem" height="5rem" class="mb-3 text-primary">
                    ...
                    <h4 class="fw-bold h5 mb-0 text-dark">24/7 Support</h4>
                </div>
            </div>
        </div>
    </div>
